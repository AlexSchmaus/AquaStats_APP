...
<div class="container">
    ...
    <div class="mainContent">
        ...
        <p class="introText">
            ...
            Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate
    ...
    <div class="rightSide">
        <p>
            Hello World! How are you doing today on this very fine day
        </p>
    </div>
</div>
